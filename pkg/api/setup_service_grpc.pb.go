...
func (c *setupServiceClient) RegisterForSetup(ctx context.Context, in *Void, opts ...grpc.CallOption) (SetupService_RegisterForSetupClient, error) {
	stream, err := c.cc.NewStream(ctx, &SetupService_ServiceDesc.Streams[0], "/helium_proto.SetupService/RegisterForSetup", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *setupServiceClient) StreamShares(ctx context.Context, opts ...grpc.CallOption) (SetupService_StreamSharesClient, error) {
	stream, err := c.cc.NewStream(ctx, &SetupService_ServiceDesc.Streams[1], "/helium_proto.SetupService/StreamShares", opts...)
	if err != nil {
		return nil, err
	}
